      ...
      <div className="event-detail">
         <div className="event-rules">
            ...
            <ul className="rule-ul">
               ...
               <li className="rule-li">
                  For more details please check out the rule book <a className='rule-link' href='https://drive.google.com/drive/folders/1t_SPtlBTfWi1dPMP2RD04LOl8TGlC59p?usp=sharing'>Techfuison2k23 Rule book</a>
               </li>
            </ul>
         </div>
